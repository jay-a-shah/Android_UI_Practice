        ...
        binding.apply {
            ...
            btnSignUp.setOnClickListener {
                ...
                if (isValidEmail(editTextEmail.text.toString())) {
                    Toast.makeText(
                        this@SignInWithPasswordActivity,
                        getString(R.string.toast_email_valid),
                        Toast.LENGTH_SHORT
                    ).show()
                } else {
                    Toast.makeText(
                        this@SignInWithPasswordActivity,
                        getString(R.string.toast_email_not_valid),
                        Toast.LENGTH_SHORT
                    ).show()
                }
            }
    ...
    private fun setSpannableText() {
        ...
        val clickableSpan2: ClickableSpan = object : ClickableSpan() {
            override fun onClick(p0: View) {
                val signInIntent = Intent(this@SignInWithPasswordActivity, SignUpActivity::class.java)
